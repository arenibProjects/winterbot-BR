...
void controlLoop(){
  ...
  Serial.print("Left:");Serial.print(cl);Serial.print(" Right:");Serial.print(cr);Serial.print(" X:");Serial.print(odometry.getX());Serial.print(" Y:");Serial.println(odometry.getY());
}
